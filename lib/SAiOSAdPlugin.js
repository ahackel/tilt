...
var cordovaRef = window.cordova; // old to new fallbacks
...
{
    cordovaRef.exec(null, null, "SAiOSAdPlugin", "orientationChanged", [window.orientation]);
}
...
{
    cordovaRef.exec(null, null, "SAiOSAdPlugin", "showAd", [show]);
}
...
SAiOSAdPlugin.prototype.prepare = function(atBottom)
{
	...
	cordovaRef.exec(null, null, "SAiOSAdPlugin", "prepare", [atBottom]);
}
